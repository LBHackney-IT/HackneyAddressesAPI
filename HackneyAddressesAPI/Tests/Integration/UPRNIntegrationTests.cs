...
using HackneyAddressesAPI;
using Microsoft.AspNetCore.Hosting;
using Microsoft.AspNetCore.TestHost;
using Xunit;

namespace HackneyAddressesAPI.Tests.Integration
{
    public class UPRNIntegrationTests
    {
        private readonly TestServer _server;
        private readonly HttpClient _client;

        private static readonly String apiVersion = "v1/Addresses";
        private static readonly String controllerName = "UPRN";
        private readonly String controllerPathPrefix = apiVersion + "/" + controllerName;

        public UPRNIntegrationTests()
        {
        ...
        {
            var result = await _client.GetAsync(controllerPathPrefix + "/012345678912");
        ...
        {
            var result = await _client.GetAsync(controllerPathPrefix + "/012345678923"); // How to generate internal server error?
