...
namespace HackneyAddressesAPI.Controllers
{
    ...
    public class SearchPostcodeController : Controller
    {
        private IValidator _validator;
        private ILLPGActions _LLPGActions;
        private ILoggerAdapter<SearchPostcodeController> _logger;

        public SearchPostcodeController(IValidator validator,
            ILLPGActions LLPGActions,
            ILoggerAdapter<SearchPostcodeController> logger)
        {
