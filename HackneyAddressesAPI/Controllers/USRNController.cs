...
namespace HackneyAddressesAPI.Controllers
{
    ...
    public class USRNController : Controller
    {
        private ILLPGActions _LLPGActions;
        private IValidator _validator;
        private IFormatter _formatter;
        private ILoggerAdapter<USRNController> _logger;

        public USRNController(IValidator validator,
            IFormatter formatter,
            ILLPGActions LLPGActions,
            ILoggerAdapter<USRNController> logger)
        {
        ...
        /// <summary>
        /// Search property details via USRN.
        /// </summary>
        /// <param name="USRN">Full USRN Number.</param>
        ...
        /// </returns>
        [HttpGet]
        public async Task<JsonResult> Get([FromQuery]string USRN,
            ...
            [FromQuery]int? Offset = GlobalConstants.OFFSET)
        {
            ...
            try
            {
                ...
                if (_validator.ValidateUSRN(USRN))
                {
                    ...
                    if (!validatorFilterErrors.ErrorOccurred)
                    {
                        ...
                        var result = await _LLPGActions.GetLlpgAddressesByUSRN(
                            USRN,
                            PropertyClassCode,
                            PropertyClass,
                            AddressStatus,
                ...
                else
                {
                    var errors = new List<ApiErrorMessage>
                    {
                        new ApiErrorMessage
                        {
                            developerMessage = "USRN is not in a valid format",
                            userMessage = "USRN is not in valid format"
                        }
                    };
