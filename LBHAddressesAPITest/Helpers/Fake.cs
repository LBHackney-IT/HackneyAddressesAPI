...
namespace LBHAddressesAPITest.Helpers
{
    public static class Fake
    {
        ...
        public static Address GenerateAddressProvidingKey(string LPI_KEY)
        {
            ...
            return GetAddress(LPI_KEY, random.Random.String(0, 8));
        ...
        public static Address GenerateAddress()
        {
            ...
            return GetAddress(random.Random.AlphaNumeric(14), random.Random.String(0, 8));            
        }
        ...
        private static Address GetAddress(string LPI_KEY, string POSTCODE)
        {
            ...
            return new Address
            {
                ...
                WARD = random.Random.String(0,100),
