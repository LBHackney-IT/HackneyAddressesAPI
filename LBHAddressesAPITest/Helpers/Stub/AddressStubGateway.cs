...
{
    public class AddressStubGateway : IRepository<AddressDetailed>
    {
        ...
        public async Task<AddressDetailed> GetAddressAsync(string lpi_key)
        {
            ...
            var all = await _db.QueryAsync<AddressDetailed>(query,
                    new { key = lpi_key }
